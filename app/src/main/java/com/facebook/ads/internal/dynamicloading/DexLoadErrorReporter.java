            ...
            new Thread() {
                ...
                public void run() {
                    /*
                        ...
                        android.content.Context r12 = r3     // Catch:{ all -> 0x015b }
                        ...
                        java.lang.String r14 = r4     // Catch:{ all -> 0x015b }
                        r12.put(r13, r14)     // Catch:{ all -> 0x015b }
                        ...
                        android.content.Context r2 = r3     // Catch:{ all -> 0x0159 }
                    ...
                    L_0x01a8:
                        goto L_0x01a7
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.internal.dynamicloading.DexLoadErrorReporter.C04741.run():void");
                }
            }.start();
        }
    }
