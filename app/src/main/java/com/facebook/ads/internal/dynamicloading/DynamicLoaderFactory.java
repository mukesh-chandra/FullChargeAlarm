...
public class DynamicLoaderFactory {
    ...
    public static void initialize(final Context context, final MultithreadedBundleWrapper multithreadedBundleWrapper, final InitListener initListener, final boolean z) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    L_0x0053:
                        goto L_0x0052
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.internal.dynamicloading.DynamicLoaderFactory.C04751.run():void");
                }
            }).start();
        }
    }
    ...
    /* access modifiers changed from: private */
    public static void doCallInitialize(Context context, DynamicLoader dynamicLoader, final Throwable th, boolean z, MultithreadedBundleWrapper multithreadedBundleWrapper, final InitListener initListener) {
        if (th != null) {
    ...
    public static DynamicLoader doMakeLoader(Context context, boolean z) throws Exception {
        ...
        if (dynamicLoader == null) {
            String str = "com.facebook.ads.internal.dynamicloading.DynamicLoaderImpl";
            if (!LOAD_FROM_ASSETS) {
                dynamicLoader = (DynamicLoader) Class.forName(str).newInstance();
            } else {
                dynamicLoader = (DynamicLoader) makeAdsSdkClassLoader(context.getApplicationContext()).loadClass(str).newInstance();
