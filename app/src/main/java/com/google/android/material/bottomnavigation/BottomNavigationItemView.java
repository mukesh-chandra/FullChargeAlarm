...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0487R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0487R.C0488drawable.design_bottom_navigation_item_background);
        this.defaultMargin = resources.getDimensionPixelSize(C0487R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0487R.C0489id.icon);
        this.smallLabel = (TextView) findViewById(C0487R.C0489id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0487R.C0489id.largeLabel);
