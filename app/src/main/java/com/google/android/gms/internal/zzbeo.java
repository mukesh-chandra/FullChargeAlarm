...
public final class zzbeo extends Fragment implements zzbdt {
    ...
    public static zzbeo zza(FragmentActivity fragmentActivity) {
        ...
        try {
            zzbeo zzbeo2 = (zzbeo) fragmentActivity.getSupportFragmentManager().findFragmentByTag(str);
            if (zzbeo2 == null || zzbeo2.isRemoving()) {
                zzbeo2 = new zzbeo();
                fragmentActivity.getSupportFragmentManager().beginTransaction().add((Fragment) zzbeo2, str).commitAllowingStateLoss();
            }
            zzaEH.put(fragmentActivity, new WeakReference(zzbeo2));
            return zzbeo2;
